      ...
      <div className="bg-gray-900 rounded-lg shadow-2xl max-w-2xl w-full max-h-screen overflow-y-auto border border-gray-800">
        ...
        <div className="p-6">
          ...
          <div className="flex gap-3 mt-6">
            <button className="flex-1 px-4 py-2.5 bg-gray-800 border border-gray-700 text-gray-300 rounded-lg hover:bg-gray-700 transition-all">
              Cancel
            </button>
            <button className="flex-1 flex items-center justify-center px-4 py-2.5 border border-gray-700 bg-green-500 text-gray-900 rounded-lg hover:bg-green-400 transition-all">
              <Check size={20} />
              Add User
            </button>
          </div>
